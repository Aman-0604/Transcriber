...
def initialize_knowledge_base():
    ...
    agent_knowledge = Knowledge(
        vector_db=LanceDb(
            ...
            embedder=HuggingfaceCustomEmbedder(id = "intfloat/multilingual-e5-large"),
        ),
    )
    ...
    # )
    agent_knowledge.add_content(
        path="/Users/aman/Projects/Transcriber/text_data.txt",
    )
...
def get_example_topics() -> List[str]:
    ...
    return [
        "Who is Aman Gupta?",
        "What Aman Gupta is telling about office hours?",
        "In which company does Aman works?",
    ]
...
def deep_knowledge_agent():
    ...
    print("\n🤔 Welcome to DeepKnowledge - Your Advanced Knowledge Assistant! 📚")
